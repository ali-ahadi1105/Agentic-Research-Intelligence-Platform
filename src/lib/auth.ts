...
if (!JWT_SECRET) {
  throw new Error(
    "JWT_SECRET is required. Set a strong random string in .env (minimum 32 characters)."
  );
}
if (JWT_SECRET.length < 32) {
  console.warn("[Auth] WARNING: JWT_SECRET is shorter than 32 characters. Use a longer secret for production.");
}
